...
function init(that, barHeight, keys, isShowKey, isShowHis, callBack) {
  ...
  console.log("view.isShow:" + view.isShow);
...
function wxSearchFocus(e, that, callBack) {
  ...
  console.log("view.isShow.1:" + that.data.wxSearchData.view.isShow);
...
function wxSearchHiddenPancel(that) {
  ...
  console.log("view.isShow.2:" + that.data.wxSearchData.view.isShow);
}
